        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-12">
                    ...
                    <!-- BOOKING FORM -->
                    <form class="booking-form-advanced" id="booking-form" method="post" action="{{ route('booking.confirm') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Country</label>
                                    <select name="booking_country" class="form-control" title="Select Your Country"
                                            ...
                                            <div class="guests-buttons">
                                                ...
                                                <div class="guests-button">
                                                    ...
                                                    <input type="text" name="booking_adults" class="booking-guests"
                                                        value="{{$bookingData['booking_adults'] ?? 0}}">
                                                    <div class="plus"></div>
                                                </div>
                                            </div>
                                            {{-- <div class="guests-buttons">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="booking_roomtype" class="form-control" title="Select Room Type" data-header="Select Room Type">
                                        ...
                                        @foreach ($roomTypes as $key => $type)
                                            <option value="{{ $key }}"
                                                {{ !empty($bookingData['booking_roomtype']) && $key == $bookingData['booking_roomtype'] ? 'selected' :  '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="booking_note" placeholder="Your Comments..."></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
